        ...
        <section id="example" class="mb-8">
            ...
            <div
                ...
                <div>
                    ...
                    <LikeButton v-on:liked="handleLike" v-on:unliked="handleUnlike" />
                </div>
                <div>
...
function handleLike(eventpremiereData:any, eventdeuxiemeData:any): void {
    console.log("On arrive a réagir quand ya un like");
    console.log(eventpremiereData);
    console.log(eventdeuxiemeData);
